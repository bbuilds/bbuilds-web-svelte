/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 0d2c85525be4d12413bc5f067cfcefef)
// Runtime types generated with workerd@1.20260820.1 2026-05-12 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	VITE_STORYBLOK_DELIVERY_API_TOKEN: string;
