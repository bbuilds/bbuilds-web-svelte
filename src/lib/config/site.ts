import ogImageDefault from '$lib/assets/og-image-default.png';
...
export const SITE_OG_IMAGE = ogImageDefault;
...
export const SITE_LOGO = `${SITE_URL}/bbuilds-logo.jpg`;
export const SOCIAL_LINKS = ['https://www.linkedin.com/in/branden-builds/'];
